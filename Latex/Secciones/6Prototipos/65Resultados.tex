...
{
%\subfloat[Espectro de emisión]
\includegraphics[scale=0.27]{Signal_Cs-137+background.png} 
}
{
%\subfloat[Espectro de emisión]
...
En este espectro podemos ver que se ha medido una señal con una actividad lijeramente inferior a $0.3~\becquerel$. Vemos que se trata de aproximadamente 3 ordenes de magnitud por debajo de lo que esperaríamos detectar.
