...
\textit{Fiber-optic radiation sensor for detection of tritium}, Nuclear Instruments and Methodsin Physics Research A, \textbf{Vol. 652} (2011) 928-931.

\bibitem{Alberto} \textsc{Alberto Soler Cambra},
\textit{ Memoria de Prácticas externas: Protocolo de preparación y caracterización de fibras centelladoras para el detector Tritium}, \textsc{Facultad de Física, Universitat de València, España}, 2017.

\bibitem{asignatura} \textsc{W. R. Leo},
\textit{Techniques for Nuclear and Particle Physics Experiments}, Springer-Verlag, $2â$ Edición, 1994. 
...
\textit{Proyecto fin de grado: Sistema de test para la caracterización de los fotomultiplicadores de silicio de la cámara de proyección temperal NEXT-100}, Escola Técnica Superior d'Enginyeria, Universitat València, España, 2013.
