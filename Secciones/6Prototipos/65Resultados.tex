...
En este espectro podemos ver que se ha medido una señal con una actividad de, aproximadamente, $0.45~\becquerel$. Vemos que se trata de aproximadamente 3 ordenes de magnitud por debajo de lo que esperaríamos detectar.

Por tanto procedemos a calcular el ángulo sólido para verificar que su valor podría explicar esta diferencia. Para ello, por un lado suponemos que únicamente tienen aprotación a la señal los fotones los cuales llegan diréctamente de la fuente y justo en la cara final del bunch son absorbidos por las fibras centelleadoras y reemitidos ya que, debido al espectro de la eficiencia de fotodetección de los PMTs, los fotones de $662~\kilo\eV$ que llegan al PMT no tendrán aprotación significativa y debido al ángulo sólido, los que se absorben a una distancía mínima de la cara final tampoco tendrán aportación. Por otro lado tenemos en cuenta que la fuente se ha situado sobre la parte central de la U y debajo de la estructura de acero que sujeta el prototipo (fig. $\ref{prototipo}$).Con todo esto el ángulo sólido calculado es aproximadamente $4.435 \cdotp 10^{-3}$. 


Vemos que este ángulo sólido justo nos aporta la diferencia de tres órdenes de magnitud que necesitamos. Tomando por válido nuestro argumento obtendríamos una señal máxima de $0.443~\becquerel$, ligeramente inferior al valor determinado.
