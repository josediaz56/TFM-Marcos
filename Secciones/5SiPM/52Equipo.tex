...
\caption{Sistema de control de temperatura y diagrama de fases~\cite{dycometal}}
\end{figure}
...
\caption{SiPMs y tarjeta de conversora intensidad-voltaje}
\end{figure}
