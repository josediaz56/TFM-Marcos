...
\item {} Por otro lado, partiendo de estos 4 vectores de dimensión 14 en nuestro caso (igual al número de ficheros que ha leido) que contienen ganancia, temperatura y sus errores de forma ordenada la macro realiza un ajuste lineal. El ajuste obtenido se presenta en la figura once.

\begin{figure}[hbtp]
\centering
\includegraphics[scale=0.4]{Dependenciatemperatura.png}
\caption{\textbf{Figura 11}.- Ganancia frente a temperatura}
\end{figure}
