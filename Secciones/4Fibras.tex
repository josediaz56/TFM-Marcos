Como se ha comentado anteriormente, el primer paso para monitorizar el agua tritiada es detectar los electrones que se producen en la desintegración $\beta^-$ del tritio $\eqref{desintegraciontritio}$. Para ello se utilizarán fibras centelleadoras, en concreto, fibras BCF-12. 
...
\caption{\textbf{Figura 2}.- Esquema de niveles energéticos de un material centelleador}
\end{figure}
...
Para poder cortar las fibras centelleadoras de forma opticamente aceptable se diseño y construyo una guillotina (referencia) adecuada la cual puede verse reflejada en la figura tres:
